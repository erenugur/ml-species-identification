...
for x in range(8):
  file_num = 1
  url = f'https://xeno-canto.org/species/Tringa-ochropus?pg={x+35}'
  ...
  for sub_url in download_links:
    ...
    open(f'/content/drive/My Drive/AI Club Species Identification Project/Datasets/Test Data (200 files)/Audio/Tringa ochropus (200 audio files)/test{counter}.wav', 'wb').write(r.content)
    counter += 1
